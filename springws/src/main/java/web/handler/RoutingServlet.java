...
public class RoutingServlet {
	...
	public RedirectView q1(
		...
		boolean isValid = validateNumbers(number1, number2, resultUser);
		...
		RedirectView redirectView = null;
		if (isValid && calculatedResult == Double.valueOf(resultUser)) {
	...
	private boolean validateNumbers(String n1, String n2, String res) {
